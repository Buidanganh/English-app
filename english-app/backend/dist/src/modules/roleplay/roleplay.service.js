...
exports.RoleplayService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../prisma/prisma.service");
let RoleplayService = class RoleplayService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async getScenarios() {
    ...
    async startSession(userId, scenarioId) {
        ...
        if (!scenario) {
            throw new common_1.NotFoundException('Tình huống nhập vai không tồn tại');
        }
    ...
    async sendMessage(userId, sessionId, userContent) {
        ...
        if (!session || session.userId !== userId) {
            throw new common_1.NotFoundException('Phiên trò chuyện không tồn tại');
        }
    ...
    async evaluateSession(userId, sessionId) {
        const session = await this.prisma.roleplaySession.findUnique({
            where: { id: sessionId },
            include: {
                scenario: true,
    ...
    getInitialTranslation(scenarioTitle) {
    ...
    generateAiReply(title, userText, msgCount) {
...
exports.RoleplayService = RoleplayService;
exports.RoleplayService = RoleplayService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], RoleplayService);
//# sourceMappingURL=roleplay.service.js.map